...
PRO=read.csv("ProcterGambleStock.csv")
CO=read.csv("CocaColaStock.csv")
...
PRO$Date=as.Date(PRO$Date,"%m/%d/%y")
...
```{r}
ggplot(CO,aes(x=Date,y=StockPrice))+geom_line()
```
