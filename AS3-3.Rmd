...
```{r}
#131302
CPS=read.csv("/Users/wenxuanlee/Desktop/R files/tony/unit03/data/CPSData.csv")
nrow(CPS)
#
```
...
```{r}
#EmploymentStatus, Industry, MetroAreaCode, Education, Married
colSums(is.na(CPS))
...
```{r}
#271
Metro=read.csv("/Users/wenxuanlee/Desktop/R files/tony/unit03/data/MetroAreaCodes.csv")
CountryMap=read.csv("/Users/wenxuanlee/Desktop/R files/tony/unit03/data/CountryCodes.csv")
...
```{r}
#cbind＝欄合併,rbind=列合併,merge=資料合併
#all.x=TRUE（合併不起來的值也貼上）
